...
class UserCreationForm(f.ModelForm):
    def __init__(self, *args, **kwargs):
            ...
            for visible in self.visible_fields():
                visible.field.widget.attrs['class'] = 'block w-full px-4 py-2 mt-2 text-pink-600 bg-white border rounded-md focus:border-pink-400 focus:ring-pink-300 focus:outline-none focus:ring focus:ring-opacity-40'
